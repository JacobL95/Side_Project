...
`Papers_Mailed_Note` varchar(250) not null,
...
insert into `Record`(`RecordID`,`Groom_ID`,`Bride_ID`,`Papers_Recieved_Date`,`Wedding_Date`,`Papers_Mailed`,
`Dispensation_Type_Number`,`Additional_Circumstances_Note`,`Dispensation_ID`,
`Catholic_Party_ID`,`Approved_By`,`Papers_Mailed_Note`,`Paperwork_Originated`,`Parish_Of_Wedding`,
`Is_Parish_Outside_Of_Diocese`,`Officiant_Name`,`Is_Convalidated`,`Has_Been_Annulled`) values

(default, 1, 1, '3/9/2018', '3/17/2018', '3/9/2018',
 1, 'Convalidation of civil marriage dated 10/7/2000', 1, 
 1, 'Fr. Riley-VG-Chancellor', 'papers returned to Christine Sanders while at Sacramental Records meeting',
 40, 40, false, 'Rev. Daniel Gill', true, false);   